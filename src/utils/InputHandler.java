            ...
            while ((line = br.readLine()) != null) {
                ...
                if (readingNodes) {
                    ...
                    if (parts.length >= 3) {
                        ...
                        System.err.println("Invalid university format: " + line);
                    }
                    ...
                    if (parts.length >= 6) {
                        ...
                        if (source != null && destination != null) {
                            ...
                            System.err.println("Unknown node in route: " + line);
                            if (source == null) {
                                System.err.println("Source node not found: " + sourceName);
                            }
                            if (destination == null) {
                                System.err.println("Destination node not found: " + destName);
                            }
                        }
                    } else {
